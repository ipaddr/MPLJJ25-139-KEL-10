...
class RiwayatDetailItem {
  ...
  final String
  jenisBantuan; // Misal: "Karbohidrat", "Susu" (subjek bantuan dari jadwal)
  final String
  deskripsiTambahan; // Detail jenis bantuan: "Beras, roti, jagung, dll."
  ...
  RiwayatDetailItem({
    ...
    required this.deskripsiTambahan,
  ...
  factory RiwayatDetailItem.fromFirestore(DocumentSnapshot doc) {
    ...
    return RiwayatDetailItem(
      ...
      deskripsiTambahan: data['deskripsiTambahan'] as String? ?? '',
