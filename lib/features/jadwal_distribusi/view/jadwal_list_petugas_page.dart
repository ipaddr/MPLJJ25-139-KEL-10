...
class _JadwalListPetugasPageState extends State<JadwalListPetugasPage> {
  ...
  Future<void> _markAsDistributed(JadwalDetailItem jadwal) async {
    ...
    setState(() {
      // Tidak ada loading indicator di sini, karena operasi cepat
    });
    ...
    try {
      ...
      for (String recipientUid in jadwal.recipientUserIds) {
        ...
        final riwayatItem = RiwayatDetailItem(
          ...
          jenisBantuan: jadwal.jenisBantuan,
          deskripsi:
              'Bantuan ${jadwal.jenisBantuan} di ${jadwal.lokasi}', // Deskripsi bisa disesuaikan
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Jenis Bantuan: ${jadwal.jenisBantuan}'),
                      Text('Lokasi: ${jadwal.lokasi}'),
                      Text('Status: ${jadwal.status}'),
                      const SizedBox(height: 8),
                      // Tampilkan daftar penerima (opsional)
                      ...
                      // Tombol untuk menandai sebagai disalurkan
                      Align(
